...
public class camara extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* Toolbar toolbar = (Toolbar) findViewById( R.id.toolbar );
        ...
        guardarr=(Button)findViewById(R.id.gbutton);

        guardarr.setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent guardar=new Intent(camara.this,camara.class);
        ...
        if (resultCode == RESULT_OK) {
            ...
            switch (requestCode) {
                case COD_SELECCIONA:
                    ...
                    client2.post("http://192.168.1.168:3000/sendimage", params2, new AsyncHttpResponseHandler() {
                        @Override
